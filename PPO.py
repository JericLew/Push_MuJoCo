...
class PPOAgent():
    ...
    def _init_hyperparameters(self):
        self.save_interval = 100 # Save model every n iterations
        self.n_steps = 500                      # number of steps in environment
        self.n_envs = 12                        # number of parallel environments
        ...
        self.entropy_coef = 0.000001             # Entropy Coefficient
        self.clip = 0.2                         # PPO clip parameter (recommended by paper)
        self.actor_lr = 0.0005                   # Actor Learning Rate
    ...
    def learn(self, iterations):
        for itr in range(iterations):
            ...
            ## Save model every self.save_interval iterations
